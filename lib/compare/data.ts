...
export const COMPARE_VERTICALS: CompareVertical[] = [
  {
    ...
    competitors: [
      ...
      { name: "Mission Heating & Cooling", anchor: "mission", rating: "4.9", reviews: "696", locallyOwned: "unknown", peOwned: "unknown", blurb: "Mission Heating & Cooling is a Tucson HVAC contractor serving residential cooling and heating needs." },
      { name: "Cool Breeze Comfort Solutions", anchor: "cool-breeze", rating: "4.8", reviews: "538", locallyOwned: "unknown", peOwned: "unknown", blurb: "Cool Breeze Comfort Solutions is a Tucson-area HVAC company providing air conditioning service and repair." },
      { name: "Chas Roberts A/C & Plumbing", anchor: "chas-roberts", rating: "4.1", reviews: "472", locallyOwned: "unknown", peOwned: "unknown", blurb: "Chas Roberts is one of Arizona's largest HVAC and plumbing companies, primarily Phoenix-based, also serving Tucson." },
      { name: "Hamstra Heating & Cooling", anchor: "hamstra", rating: "4.9", reviews: "2,700", locallyOwned: "unknown", peOwned: "unknown", blurb: "Hamstra Heating & Cooling is a long-running Tucson HVAC contractor serving residential and commercial customers." },
      { name: "Oasis Heating & Cooling", anchor: "oasis", rating: "4.8", reviews: "374", locallyOwned: "unknown", peOwned: "unknown", blurb: "Oasis is a Tucson-area HVAC company offering air conditioning and heating service." },
      { name: "Ambient Air", anchor: "ambient-air", rating: "4.8", reviews: "621", locallyOwned: "unknown", peOwned: "unknown", blurb: "Ambient Air is a Tucson HVAC contractor providing cooling and heating services." },
      { name: "Green Valley Cooling & Heating", anchor: "green-valley-ch", rating: "5.0", reviews: "5,237", locallyOwned: "unknown", peOwned: "unknown", blurb: "Green Valley Cooling & Heating serves the Green Valley and southern Tucson HVAC market." },
      { name: "Rincon Air", anchor: "rincon-air", rating: "4.8", reviews: "108", locallyOwned: "unknown", peOwned: "unknown", blurb: "Rincon Air is a Tucson-area HVAC company offering A/C and heating service." },
      { name: "Russett Southwest", anchor: "russett-southwest", rating: "4.9", reviews: "1,548", locallyOwned: "unknown", peOwned: "unknown", blurb: "Russett Southwest is a long-established Tucson HVAC contractor serving residential and commercial customers." },
      { name: "Semper Fi Heating & Cooling", anchor: "semper-fi", rating: "4.8", reviews: "274", locallyOwned: "unknown", peOwned: "unknown", blurb: "Semper Fi Heating & Cooling is a Tucson HVAC company providing cooling and heating service." },
      { name: "Smart Choice Heating & Cooling", anchor: "smart-choice", rating: "4.7", reviews: "741", locallyOwned: "unknown", peOwned: "unknown", blurb: "Smart Choice Heating & Cooling is a Tucson-area HVAC contractor." },
      { name: "Done Rite Services", anchor: "done-rite", rating: "4.9", reviews: "603", locallyOwned: "unknown", peOwned: "unknown", blurb: "Done Rite Services is a Tucson HVAC and home-services contractor." },
      { name: "Family Air Cooling & Heating", anchor: "family-air", rating: "4.7", reviews: "408", locallyOwned: "unknown", peOwned: "unknown", blurb: "Family Air Cooling & Heating is a Tucson HVAC company serving residential customers." },
      ...
      { name: "Jett Mechanical", anchor: "jett-mechanical", rating: "4.4", reviews: "87", locallyOwned: "unknown", peOwned: "unknown", blurb: "Jett Mechanical is a Tucson-area HVAC and mechanical services contractor." },
      { name: "StrongBuilt Plumbing", anchor: "strongbuilt-hvac", rating: "4.7", reviews: "2,931", locallyOwned: "unknown", peOwned: "unknown", blurb: "StrongBuilt is a Tucson home-services company offering plumbing and related trades." },
    ],
    testimonials: [
  ...
  },
  {
    ...
    competitors: [
      ...
      { name: "Fusion Plumbing & Air", anchor: "fusion", rating: "4.9", reviews: "922", locallyOwned: "unknown", peOwned: "unknown", blurb: "Fusion Plumbing & Air is a Tucson plumbing and HVAC company." },
      { name: "Cool Willy's", anchor: "cool-willys", rating: "4.9", reviews: "1,601", locallyOwned: "unknown", peOwned: "unknown", blurb: "Cool Willy's is a Tucson-area plumbing and home-services contractor." },
      { name: "StrongBuilt Plumbing", anchor: "strongbuilt", rating: "4.7", reviews: "2,931", locallyOwned: "unknown", peOwned: "unknown", blurb: "StrongBuilt is a Tucson plumbing company offering residential plumbing services." },
      { name: "Bryant's Plumbing", anchor: "bryants", rating: "4.9", reviews: "20", locallyOwned: "unknown", peOwned: "unknown", blurb: "Bryant's Plumbing is a Tucson plumbing company offering repair and installation." },
    ],
    testimonials: [
  ...
  },
  {
    ...
    competitors: [
      ...
      { name: "Lyons Roofing", anchor: "lyons", rating: "4.6", reviews: "152", locallyOwned: "unknown", peOwned: "unknown", blurb: "Lyons Roofing is a long-established Arizona roofing company serving Tucson and Phoenix." },
      { name: "KY-KO Roofing", anchor: "ky-ko", rating: "4.6", reviews: "363", locallyOwned: "unknown", peOwned: "unknown", blurb: "KY-KO Roofing is an Arizona roofing contractor offering repair and replacement." },
    ],
    testimonials: [
