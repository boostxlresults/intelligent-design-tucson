...
export const tanqueverdeData: LocationPageData = {
  ...
  description: 'Trusted home services in Tanque Verde, east Tucson. HVAC, plumbing, solar, electrical & roofing. Serving families near Saguaro National Park. Same-day service available.',
  slug: 'tanque-verde',
  ...
  content: {
    sections: [
      ...
      {
            "type": "paragraph",
            "content": "Whether your home is near Wentworth Road, along Tanque Verde Road, or in the neighborhoods surrounding Saguaro National Park, we're here to provide exceptional home services with the care and expertise your family deserves."
      },
      {
            "type": "heading",
      ...
      {
            "type": "paragraph",
            "content": "Common questions about our Tanque Verde services"
      },
      {
            "type": "heading",
      ...
      {
            "type": "paragraph",
            "content": "Join thousands of satisfied Tanque Verde homeowners who trust Intelligent Design for all their home service needs."
      }
]
      }
],
