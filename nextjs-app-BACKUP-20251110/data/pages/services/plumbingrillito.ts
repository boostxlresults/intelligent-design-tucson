...
// Auto-generated from PlumbingRillito.tsx
...
export const plumbingrillitoData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Rillito, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-rillito',
  
  // Hero Section
  h1: 'Plumbing Services in Rillito, AZ',
  h2Subheading: 'Expert Plumbing Rillito in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Rillito in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Rillito',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Rillito plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Rillito Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Rillito Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Rillito Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Rillito | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Rillito",
            "level": 2,
            "content": "Complete Plumbing Services for Rillito"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Rillito plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
