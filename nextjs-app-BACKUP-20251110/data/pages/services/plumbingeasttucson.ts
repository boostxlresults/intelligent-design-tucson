...
// Auto-generated from PlumbingEastTucson.tsx
...
export const plumbingeasttucsonData: ServicePageData = {
  ...
  description: 'Expert plumbing services in East Tucson, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-east-tucson',
  
  // Hero Section
  h1: 'Plumbing Services in East Tucson, AZ',
  h2Subheading: 'Expert Plumbing East Tucson in Tucson',
  ...
  // Service Info
  serviceName: 'Plumbing East Tucson',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know East Tucson plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing East Tucson Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving East Tucson Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving East Tucson Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout East Tucson | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for East Tucson",
            "level": 2,
            "content": "Complete Plumbing Services for East Tucson"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know East Tucson plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "East Tucson Plumbing FAQs",
            "level": 2,
            "content": "East Tucson Plumbing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Plumber in East Tucson?",
            "level": 2,
            "content": "Need a Plumber in East Tucson?"
      },
      {
            "type": "paragraph",
