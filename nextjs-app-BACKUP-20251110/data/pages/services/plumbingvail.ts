...
// Auto-generated from PlumbingVail.tsx
...
export const plumbingvailData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Vail, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-vail',
  
  // Hero Section
  h1: 'Plumbing Services in Vail, AZ',
  h2Subheading: 'Expert Plumbing Vail in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Vail in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Vail',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Vail plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Vail Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Vail Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Vail Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Vail | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Vail",
            "level": 2,
            "content": "Complete Plumbing Services for Vail"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Vail plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Vail Plumbing FAQs",
            "level": 2,
            "content": "Vail Plumbing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Plumber in Vail?",
            "level": 2,
            "content": "Need a Plumber in Vail?"
      },
      {
            "type": "paragraph",
