...
export const roofingcoronadetucsonData: ServicePageData = {
  ...
  description: 'Professional roofing services in Corona de Tucson, AZ. Expert roof repair, replacement, inspection, coating. Tile, shingle, flat roofs. 24/7 emergency service. BBB A+ rated.',
  slug: 'roofing-coronade-tucson',
  
  // Hero Section
  h1: 'Professional Roofing Services in Corona de Tucson, AZ',
  h2Subheading: 'Expert Roofing Coronade Tucson in Tucson',
  tagline: 'Roof Repair | Replacement | Inspection | Coating | Tile & Shingle | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Roofing Coronade Tucson in Tucson',
  
  // Service Info
  serviceName: 'Roofing Coronade Tucson',
  category: 'Roofing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Corona de Tucson roofing systems, climate challenges, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Roofing Coronade Tucson Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Roofer Serving Corona de Tucson Since 1979",
            "level": 2,
            "content": "Trusted Roofer Serving Corona de Tucson Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Complete Roofing Services for Corona de Tucson",
            "level": 2,
            "content": "Complete Roofing Services for Corona de Tucson"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Corona de Tucson roofing systems, climate challenges, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Corona de Tucson Roofing FAQs",
            "level": 2,
            "content": "Corona de Tucson Roofing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Roofer in Corona de Tucson?",
            "level": 2,
            "content": "Need a Roofer in Corona de Tucson?"
      },
      {
            "type": "paragraph",
