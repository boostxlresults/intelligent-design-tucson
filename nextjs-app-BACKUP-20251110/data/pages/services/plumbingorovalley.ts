...
// Auto-generated from PlumbingOroValley.tsx
...
export const plumbingorovalleyData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Oro Valley, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-oro-valley',
  
  // Hero Section
  h1: 'Plumbing Services in Oro Valley, AZ',
  h2Subheading: 'Expert Plumbing Oro Valley in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Oro Valley in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Oro Valley',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Oro Valley plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Oro Valley Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Oro Valley Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Oro Valley Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Oro Valley | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Oro Valley",
            "level": 2,
            "content": "Complete Plumbing Services for Oro Valley"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Oro Valley plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Oro Valley Plumbing FAQs",
            "level": 2,
            "content": "Oro Valley Plumbing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Plumber in Oro Valley?",
            "level": 2,
            "content": "Need a Plumber in Oro Valley?"
      },
      {
            "type": "paragraph",
