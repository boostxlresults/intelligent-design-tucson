...
// Auto-generated from PlumbingMarana.tsx
...
export const plumbingmaranaData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Marana, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-marana',
  
  // Hero Section
  h1: 'Plumbing Services in Marana, AZ',
  h2Subheading: 'Expert Plumbing Marana in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Marana in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Marana',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Marana plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Marana Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Marana Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Marana Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Marana | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Marana",
            "level": 2,
            "content": "Complete Plumbing Services for Marana"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Marana plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Marana Plumbing FAQs",
            "level": 2,
            "content": "Marana Plumbing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Plumber in Marana?",
            "level": 2,
            "content": "Need a Plumber in Marana?"
      },
      {
            "type": "paragraph",
