...
// Auto-generated from PlumbingAvraValley.tsx
...
export const plumbingavravalleyData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Avra Valley, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-avra-valley',
  
  // Hero Section
  h1: 'Plumbing Services in Avra Valley, AZ',
  h2Subheading: 'Expert Plumbing Avra Valley in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Avra Valley in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Avra Valley',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Avra Valley plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Avra Valley Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Avra Valley Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Avra Valley Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Avra Valley | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Avra Valley",
            "level": 2,
            "content": "Complete Plumbing Services for Avra Valley"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Avra Valley plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Avra Valley Plumbing FAQs",
            "level": 2,
            "content": "Avra Valley Plumbing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Plumber in Avra Valley?",
            "level": 2,
            "content": "Need a Plumber in Avra Valley?"
      },
      {
            "type": "paragraph",
