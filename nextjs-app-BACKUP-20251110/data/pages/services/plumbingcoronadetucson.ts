...
// Auto-generated from PlumbingCoronadeTucson.tsx
...
export const plumbingcoronadetucsonData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Corona de Tucson, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-coronade-tucson',
  
  // Hero Section
  h1: 'Plumbing Services in Corona de Tucson, AZ',
  h2Subheading: 'Expert Plumbing Coronade Tucson in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Coronade Tucson in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Coronade Tucson',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Corona de Tucson plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Coronade Tucson Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Corona de Tucson Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Corona de Tucson Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Corona de Tucson | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Corona de Tucson",
            "level": 2,
            "content": "Complete Plumbing Services for Corona de Tucson"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Corona de Tucson plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Corona de Tucson Plumbing FAQs",
            "level": 2,
            "content": "Corona de Tucson Plumbing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Plumber in Corona de Tucson?",
            "level": 2,
            "content": "Need a Plumber in Corona de Tucson?"
      },
      {
            "type": "paragraph",
