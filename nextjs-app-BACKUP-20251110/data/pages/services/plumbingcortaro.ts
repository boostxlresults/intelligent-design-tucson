...
// Auto-generated from PlumbingCortaro.tsx
...
export const plumbingcortaroData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Cortaro, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-cortaro',
  
  // Hero Section
  h1: 'Plumbing Services in Cortaro, AZ',
  h2Subheading: 'Expert Plumbing Cortaro in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Cortaro in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Cortaro',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Cortaro plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Cortaro Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Cortaro Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Cortaro Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Cortaro | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Cortaro",
            "level": 2,
            "content": "Complete Plumbing Services for Cortaro"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Cortaro plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Need a Plumber in Cortaro?",
            "level": 2,
            "content": "Need a Plumber in Cortaro?"
      },
      {
            "type": "paragraph",
