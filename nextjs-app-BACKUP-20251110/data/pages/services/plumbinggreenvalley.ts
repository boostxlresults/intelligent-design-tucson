...
// Auto-generated from PlumbingGreenValley.tsx
...
export const plumbinggreenvalleyData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Green Valley, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-green-valley',
  
  // Hero Section
  h1: 'Plumbing Services in Green Valley, AZ',
  h2Subheading: 'Expert Plumbing Green Valley in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Green Valley in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Green Valley',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Green Valley plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Green Valley Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Green Valley Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Green Valley Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Green Valley | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Green Valley",
            "level": 2,
            "content": "Complete Plumbing Services for Green Valley"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Green Valley plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Green Valley Plumbing FAQs",
            "level": 2,
            "content": "Green Valley Plumbing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Plumber in Green Valley?",
            "level": 2,
            "content": "Need a Plumber in Green Valley?"
      },
      {
            "type": "paragraph",
