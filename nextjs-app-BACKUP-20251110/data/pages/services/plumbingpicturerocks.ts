...
// Auto-generated from PlumbingPictureRocks.tsx
...
export const plumbingpicturerocksData: ServicePageData = {
  ...
  description: 'Expert plumbing services in Picture Rocks, AZ. Licensed plumbers for repairs, installations, drain cleaning, water heaters, leak detection. 24/7 emergency service. BBB A+ rated.',
  slug: 'plumbing-picture-rocks',
  
  // Hero Section
  h1: 'Plumbing Services in Picture Rocks, AZ',
  h2Subheading: 'Expert Plumbing Picture Rocks in Tucson',
  tagline: 'Expert Repairs | Water Heaters | Drain Cleaning | Leak Detection | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Plumbing Picture Rocks in Tucson',
  
  // Service Info
  serviceName: 'Plumbing Picture Rocks',
  category: 'Plumbing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Picture Rocks plumbing systems, water conditions, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Plumbing Picture Rocks Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Plumber Serving Picture Rocks Since 1979",
            "level": 2,
            "content": "Trusted Plumber Serving Picture Rocks Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "list",
            "content": "24/7 Emergency Response: Available around the clock for urgent plumbing needs | Licensed Arizona Plumbers: Fully licensed, bonded, and insured professionals | Upfront Pricing: Clear estimates before work begins, no surprise charges | Fast Service: Same-day and emergency service throughout Picture Rocks | Quality Workmanship: Comprehensive warranties on parts and labor",
            "items": [
      ...
      {
            "type": "heading",
            "heading": "Complete Plumbing Services for Picture Rocks",
            "level": 2,
            "content": "Complete Plumbing Services for Picture Rocks"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Picture Rocks plumbing systems, water conditions, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Picture Rocks Plumbing FAQs",
            "level": 2,
            "content": "Picture Rocks Plumbing FAQs"
      },
      {
            "type": "heading",
