...
export const roofingtucsonestatesData: ServicePageData = {
  ...
  description: 'Professional roofing services in Tucson Estates, AZ. Expert roof repair, replacement, inspection, coating. Tile, shingle, flat roofs. 24/7 emergency service. BBB A+ rated.',
  slug: 'roofing-tucson-estates',
  
  // Hero Section
  h1: 'Professional Roofing Services in Tucson Estates, AZ',
  h2Subheading: 'Expert Roofing Tucson Estates in Tucson',
  tagline: 'Roof Repair | Replacement | Inspection | Coating | Tile & Shingle | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Roofing Tucson Estates in Tucson',
  
  // Service Info
  serviceName: 'Roofing Tucson Estates',
  category: 'Roofing',
  ...
  highlights: [
  {
    ...
    "description": "Local expertise since 1979. We know Tucson Estates roofing systems, climate challenges, and code requirements inside and out."
  },
  {
  ...
  content: {
    mainHeading: 'Best Roofing Tucson Estates Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Roofer Serving Tucson Estates Since 1979",
            "level": 2,
            "content": "Trusted Roofer Serving Tucson Estates Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Complete Roofing Services for Tucson Estates",
            "level": 2,
            "content": "Complete Roofing Services for Tucson Estates"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Tucson Estates roofing systems, climate challenges, and code requirements inside and out."
      },
      {
            "type": "paragraph",
