...
import heroImageUrl from "@assets/generated_images/Hero_with_van_far_right_be346bd6.webp";
    ...
    <section className="relative min-h-[450px] md:min-h-[500px] flex items-start overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          loading="eager"
        />
        {/* Left-to-right gradient overlay for text readability - video-ready structure */}
