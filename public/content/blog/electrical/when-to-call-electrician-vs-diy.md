---
title: "When to Call an Electrician vs. DIY: Safety Guidelines for Tucson Homeowners"
description: Know when electrical work requires a licensed professional and what minor tasks are safe for DIY. Learn Arizona electrical code requirements and safety guidelines from Tucson's trusted electricians.
...
tags:
  ...
  - electrical-permits
  - home-improvement
heroImage: /generated_images/electrician_vs_diy.png
featured: false
canonicalUrl: https://www.idesignac.com/blog/electrical/when-to-call-electrician-vs-diy
---
...
Never open your electrical panel to work inside unless you're a licensed electrician. The bus bars carry full voltage even when breakers are off.

**Aluminum Wiring Connections**
Homes with aluminum wiring require special techniques and materials. Improper connections cause fires.

**Grounding System Work**
Improper grounding creates shock and fire hazards. This requires understanding of electrical theory.

**Outdoor Wiring**
Exterior electrical work must be weather-rated and properly protected. Water and electricity don't mix.
...
1. **Am I 100% confident I can turn off power to this circuit?**
   - If not, stop.
...
4. **Am I modifying existing wiring or just replacing components?**
   - Modifications require professional help.

5. **Do I fully understand what I'm doing?**
   - YouTube videos aren't the same as professional training.

6. **What's the worst that could happen if I make a mistake?**
