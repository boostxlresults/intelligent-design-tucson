...
export default function SolarInstallationGreenValley() {
  const description = "Professional solar panel installation in Green Valley, AZ. Expert design, premium equipment, 30% federal tax credit assistance. Serving Green Valley families since 1979. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-solar-green-valley.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Solar Installation in Green Valley, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": `${SITE_URL}/solar-installation-green-valley`
        }
      ]
    };
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is Green Valley a good location for solar panels?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Absolutely! Green Valley receives over 350 days of sunshine annually, making it one of the best locations in the United States for solar energy production. The combination of abundant sunshine, favorable net metering policies, and high TEP electric rates make solar an excellent investment for Green Valley homeowners."
          }
        },
        {
          "@type": "Question",
          "name": "How much can I save with solar in Green Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Green Valley homeowners typically save $1,200-$2,400 annually on electricity bills with solar panels. Over 25 years, total savings average $30,000-$60,000 depending on system size and energy usage. The 30% federal tax credit and TEP net metering program enhance these savings significantly."
          }
        },
        {
          "@type": "Question",
          "name": "Do I need special permits for solar in Green Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, solar installations in Green Valley require building permits and electrical permits from the Town of Green Valley. We handle all permitting, including HOA approvals if applicable, structural calculations, and utility interconnection applications. Most Green Valley permits are approved within 2-3 weeks."
          }
        },
        {
          "@type": "Question",
          "name": "How long does solar installation take in Green Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "From consultation to activation, the typical timeline is 6-10 weeks. Design and permitting take 3-5 weeks, physical installation takes 1-3 days, and utility approval takes 2-4 weeks. We coordinate all aspects to ensure a smooth process for Green Valley homeowners."
          }
        },
        {
          "@type": "Question",
          "name": "What's the ROI for solar panels in Green Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Green Valley solar systems typically pay for themselves in 7-10 years through energy savings and tax credits. After payback, homeowners enjoy 15+ years of free electricity. Solar also increases home values by approximately $15,000-$25,000 in the Green Valley market."
          }
        }
      ]
    };
  ...
  const benefits = [
    {
      ...
      description: "Green Valley's exceptional sunshine makes solar highly productive"
    },
    {
      icon: CheckCircle2,
    ...
    },
    {
      ...
      description: "Most Green Valley systems installed in 1-3 days"
    }
  ];
  ...
  return (
    <>
      <MetaHead
        title="Solar Installation Green Valley AZ | Solar Panel Installation"
        description={description}
        canonical={`${SITE_URL}/solar-installation-green-valley`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'Solar Installation Green Valley AZ | Solar Panel Installation' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/solar-installation-green-valley` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'Solar Installation Green Valley AZ | Solar Panel Installation' },
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight" data-testid="heading-hero">
                  Solar Installation in Green Valley, AZ
                </h1>
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-[hsl(25,85%,55%)]/5 border-l-4 border-[hsl(25,85%,55%)] p-6 mb-8">
                  <h3 className="text-xl font-bold text-[hsl(215,70%,25%)] mb-3">
                    Why Green Valley is Perfect for Solar
                  </h3>
                  <ul className="space-y-2 text-[hsl(215,10%,30%)]">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-[hsl(25,85%,55%)] flex-shrink-0 mt-0.5" />
                      <span><strong>Home Value Increase:</strong> Solar adds $15,000-$25,000 to Green Valley property values</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-[hsl(25,85%,55%)] flex-shrink-0 mt-0.5" />
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Local expertise since 1979. We understand Green Valley's unique requirements, from HOA guidelines to optimal roof orientations given local topography.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Tier-1 solar panels with 25-year warranties, high-efficiency inverters, and racking systems engineered for Green Valley's climate.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">BBB A+ rated with thousands of satisfied Green Valley customers. Our reputation is built on quality work and exceptional service.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">We handle all Green Valley permits, HOA approvals, and TEP interconnection paperwork. You don't lift a finger.</p>
                    </div>
                  </div>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-8 text-center">
                  Green Valley Solar Installation FAQs
                </h2>
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Is Green Valley a good location for solar panels?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Absolutely! Green Valley receives over 350 days of sunshine annually, making it one of the best locations in the United States for solar energy production. The combination of abundant sunshine, favorable net metering policies, and high TEP electric rates make solar an excellent investment for Green Valley homeowners.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-2" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      How much can I save with solar in Green Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Green Valley homeowners typically save $1,200-$2,400 annually on electricity bills with solar panels. Over 25 years, total savings average $30,000-$60,000 depending on system size and energy usage. The 30% federal tax credit and TEP net metering program enhance these savings significantly.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-3" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do I need special permits for solar in Green Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Yes, solar installations in Green Valley require building permits and electrical permits from the Town of Green Valley. We handle all permitting, including HOA approvals if applicable, structural calculations, and utility interconnection applications. Most Green Valley permits are approved within 2-3 weeks.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-4" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      How long does solar installation take in Green Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      From consultation to activation, the typical timeline is 6-10 weeks. Design and permitting take 3-5 weeks, physical installation takes 1-3 days, and utility approval takes 2-4 weeks. We coordinate all aspects to ensure a smooth process for Green Valley homeowners.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      What's the ROI for solar panels in Green Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Green Valley solar systems typically pay for themselves in 7-10 years through energy savings and tax credits. After payback, homeowners enjoy 15+ years of free electricity. Solar also increases home values by approximately $15,000-$25,000 in the Green Valley market.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </div>
          ...
          <section className="py-16 bg-[hsl(215,70%,25%)] text-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Ready to Go Solar in Green Valley?
              </h2>
