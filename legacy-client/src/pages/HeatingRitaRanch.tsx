...
import heroImage from "@assets/generated_images/Heating_tech_burner_inspection_09779c7f.webp";

export default function HeatingRitaRanch() {
  const description = "Professional heating services in Rita Ranch, AZ. Furnace repair, installation, maintenance, heat pumps. 24/7 emergency heater service. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-heating-rita-ranch.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Heating Services in Rita Ranch, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Heating Rita Ranch",
          "item": `${SITE_URL}/heating-rita-ranch`
        }
      ]
    };

    const schemas = [
      { id: 'service-schema', data: serviceSchema, attr: 'heating-rita-ranch-service' },
      { id: 'breadcrumb-schema', data: breadcrumbSchema, attr: 'heating-rita-ranch-breadcrumb' },
    ];
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock emergency heating repair for Rita Ranch residents"
    },
    {
      icon: Award,
  ...
  return (
    <>
      <MetaHead
        ...
        description={description}
        canonical={`${SITE_URL}/heating-rita-ranch`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'Heating Services Rita Ranch AZ | Furnace Repair & Installation' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/heating-rita-ranch` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'Heating Services Rita Ranch AZ | Furnace Repair & Installation' },
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1">
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight" data-testid="heading-hero">
                  Heating Services in Rita Ranch, AZ
                </h1>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6">
                  Trusted Heating Company Serving Rita Ranch Since 1979
                </h2>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6 mt-12">
                  Complete Heating Services for Rita Ranch
                </h2>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Local expertise since 1979. We know Rita Ranch heating systems, climate considerations, and efficiency solutions inside and out.</p>
                    </div>
                  </div>
          ...
          <ServiceFAQ faqs={heatingLocationFAQs.faqs} sectionHeading="Rita Ranch Heating FAQs" serviceName={heatingLocationFAQs.serviceName} serviceId={heatingLocationFAQs.serviceId} />
          ...
          <section className="py-16 bg-[hsl(215,70%,25%)] text-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Need Heating Service in Rita Ranch?
              </h2>
