...
import heroImage from "@assets/generated_images/Tucson_Estates_residential_streets_32c63592.webp";
import { Link } from "wouter";

export default function TucsonEstates() {
  const description = "Expert HVAC, plumbing, solar, electrical, roofing, and drain services in Tucson Estates. Serving this family-friendly community southwest of Tucson since 1979. 24/7 emergency service. BBB A+ rated with 22,000+ five-star reviews.";
  ...
  useEffect(() => {
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you serve Tucson Estates, Arizona?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We proudly serve all of Tucson Estates and the surrounding areas. Tucson Estates is a family-friendly community southwest of Tucson that we've been serving since 1979. We provide same-day service for HVAC, plumbing, solar, electrical, and roofing needs throughout the community."
          }
        },
        {
          "@type": "Question",
          "name": "What services do you offer in Tucson Estates?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "How quickly can you respond to Tucson Estates service calls?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We offer fast response times throughout Tucson Estates. For emergency calls, we typically arrive within 1-2 hours. For scheduled appointments, we offer same-day and next-day service. Our proximity to Tucson Estates allows us to serve you quickly and efficiently."
          }
        },
        {
          "@type": "Question",
          "name": "Do you offer emergency service in Tucson Estates?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Absolutely! We provide 24/7 emergency service for HVAC, plumbing, and electrical emergencies in Tucson Estates. Whether it's a broken AC in summer heat, a plumbing leak, or an electrical issue, call us anytime at (520) 333-2665 for immediate assistance."
          }
        },
        {
          "@type": "Question",
          "name": "Are you licensed to work in Tucson Estates?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What makes you different from other Tucson Estates contractors?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We've been serving the Tucson Estates area since 1979 with comprehensive warranties, upfront pricing, and 100% satisfaction guarantees. With over 22,000 five-star reviews, our reputation speaks for itself. We're a family-owned business committed to treating your home with the care it deserves."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Can you help with solar installation in Tucson Estates?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Definitely! Tucson Estates' sunny climate is perfect for solar energy. We offer residential solar panel installations, solar AC systems, and ongoing maintenance. We'll help you maximize federal tax credits and local incentives."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What are your service hours for Tucson Estates?",
          "acceptedAnswer": {
            "@type": "Answer",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.idesignac.com/tucson-estates"
        }
      ]
    };
  ...
  const services = [
    {
      ...
      description: "Expert AC repair, installation, and maintenance for Tucson Estates' extreme heat.",
      link: "/hvac-tucson-estates"
    },
    {
      icon: Flame,
      title: "Heating",
      description: "Reliable heating services to keep you warm during chilly desert nights.",
      link: "/heating-tucson-estates"
    },
    {
      icon: Droplet,
      title: "Plumbing",
      description: "Complete plumbing services from leak repairs to water heater installations.",
      link: "/plumbing-tucson-estates"
    },
    {
      icon: Sun,
      title: "Solar",
      description: "Professional solar panel installation and maintenance for Tucson Estates homes.",
      link: "/solar-installation-tucson-estates"
    },
    {
      icon: Zap,
      title: "Electrical",
      description: "Licensed electrical services including panel upgrades and repairs.",
      link: "/electrical-tucson-estates"
    },
    {
      icon: HomeIcon,
      title: "Roofing",
      description: "Expert roof repair, installation, and coating services for Arizona homes.",
      link: "/roofing-tucson-estates"
    },
    {
      icon: Wrench,
      title: "Drain & Sewer",
  ...
  return (
    <>
      <MetaHead
        title="HVAC, Plumbing, Solar, Electrical & Roofing Services in Tucson Estates, AZ | Intelligent Design"
        description={description}
        canonical="https://www.idesignac.com/tucson-estates"
        openGraph={[
          { property: 'og:title', content: 'HVAC, Plumbing, Solar, Electrical & Roofing Services in Tucson Estates, AZ | Intelligent Design' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: 'https://www.idesignac.com/tucson-estates' },
          { property: 'og:type', content: 'website' },
          { property: 'og:site_name', content: 'Intelligent Design' },
          { property: 'og:locale', content: 'en_US' },
          { property: 'og:image:width', content: '1200' },
          { property: 'og:image:height', content: '630' },
          { property: 'og:image:alt', content: 'Tucson Estates Arizona residential streets' }
        ]}
        twitter={[
          { name: 'twitter:card', content: 'summary_large_image' },
          { name: 'twitter:title', content: 'HVAC, Plumbing, Solar, Electrical & Roofing Services in Tucson Estates, AZ | Intelligent Design' },
          { name: 'twitter:description', content: description },
          { name: 'twitter:image', content: imageUrl },
          { name: 'twitter:image:alt', content: 'Tucson Estates Arizona residential streets' }
        ]}
      />
      <GTM />
      <DNIInjector />
        ...
        <main className="flex-1">
          ...
          <section className="relative min-h-[600px] md:min-h-[700px] flex items-center">
            <div className="absolute inset-0 z-0">
              <img
                src={heroImage}
                alt="Tucson Estates Arizona residential streets"
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6" data-testid="hero-title">
                  HVAC, Plumbing, Solar, Electrical & Roofing Services in Tucson Estates, AZ
                </h1>
                <p className="text-xl md:text-2xl text-white/90 mb-4" data-testid="hero-subtitle">
                  Serving Tucson Estates' Family-Friendly Community
                </p>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6" data-testid="intro-title">
                  Proud to Serve Tucson Estates, Arizona
                </h2>
                <p className="text-lg text-[hsl(215,10%,40%)] mb-6" data-testid="intro-description">
                  Since 1979, Intelligent Design has been serving Tucson Estates families with expert HVAC, plumbing, solar, electrical, roofing, and drain services. We understand the unique needs of this family-friendly community southwest of Tucson.
                </p>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-4" data-testid="services-title">
                  Complete Home Services in Tucson Estates
                </h2>
          ...
          {/* About Tucson Estates Section */}
          <section className="py-16 md:py-20 bg-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6" data-testid="about-area-title">
                  About Tucson Estates, Arizona
                </h2>
                <p className="text-lg text-[hsl(215,10%,40%)] mb-6" data-testid="about-area-description">
                  Tucson Estates is a well-established unincorporated community southwest of Tucson, known for its affordable homes and family-friendly atmosphere. This area offers residents a peaceful suburban lifestyle with easy access to Tucson's amenities.
                </p>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    ...
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-1-description">
                      Tucson Estates offers some of the most affordable housing in the Tucson area, making it ideal for first-time homebuyers and growing families. The community features a variety of single-family homes on spacious lots.
                    </p>
                  </div>
                  ...
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    ...
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-2-description">
                      The area features several parks and open spaces for outdoor activities. Families enjoy easy access to the Tucson Mountains, Saguaro National Park West, and numerous hiking and biking trails perfect for enjoying Arizona's natural beauty.
                    </p>
                  </div>
                  ...
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    ...
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-3-description">
                      Located along Ajo Way and near I-19, Tucson Estates provides easy commuting to downtown Tucson, the airport, and surrounding areas. Residents enjoy suburban tranquility while remaining close to urban conveniences.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="bg-white rounded-lg px-6" data-testid="faq-item-1">
                    <AccordionTrigger className="text-left font-semibold">
                      Do you serve Tucson Estates, Arizona?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Yes! We proudly serve all of Tucson Estates and the surrounding areas. Tucson Estates is a family-friendly community southwest of Tucson that we've been serving since 1979. We provide same-day service for HVAC, plumbing, solar, electrical, and roofing needs throughout the community.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-2" className="bg-white rounded-lg px-6" data-testid="faq-item-2">
                    <AccordionTrigger className="text-left font-semibold">
                      What services do you offer in Tucson Estates?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <AccordionItem value="item-3" className="bg-white rounded-lg px-6" data-testid="faq-item-3">
                    <AccordionTrigger className="text-left font-semibold">
                      How quickly can you respond to Tucson Estates service calls?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      We offer fast response times throughout Tucson Estates. For emergency calls, we typically arrive within 1-2 hours. For scheduled appointments, we offer same-day and next-day service. Our proximity to Tucson Estates allows us to serve you quickly and efficiently.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-4" className="bg-white rounded-lg px-6" data-testid="faq-item-4">
                    <AccordionTrigger className="text-left font-semibold">
                      Do you offer emergency service in Tucson Estates?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Absolutely! We provide 24/7 emergency service for HVAC, plumbing, and electrical emergencies in Tucson Estates. Whether it's a broken AC in summer heat, a plumbing leak, or an electrical issue, call us anytime at (520) 333-2665 for immediate assistance.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="bg-white rounded-lg px-6" data-testid="faq-item-5">
                    <AccordionTrigger className="text-left font-semibold">
                      Are you licensed to work in Tucson Estates?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <AccordionItem value="item-6" className="bg-white rounded-lg px-6" data-testid="faq-item-6">
                    <AccordionTrigger className="text-left font-semibold">
                      What makes you different from other Tucson Estates contractors?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      We've been serving the Tucson Estates area since 1979 with comprehensive warranties, upfront pricing, and 100% satisfaction guarantees. With over 22,000 five-star reviews, our reputation speaks for itself. We're a family-owned business committed to treating your home with the care it deserves.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-8" className="bg-white rounded-lg px-6" data-testid="faq-item-8">
                    <AccordionTrigger className="text-left font-semibold">
                      Can you help with solar installation in Tucson Estates?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Definitely! Tucson Estates' sunny climate is perfect for solar energy. We offer residential solar panel installations, solar AC systems, and ongoing maintenance. We'll help you maximize federal tax credits and local incentives.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-10" className="bg-white rounded-lg px-6" data-testid="faq-item-10">
                    <AccordionTrigger className="text-left font-semibold">
                      What are your service hours for Tucson Estates?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <Card data-testid="scheduler-card">
                    ...
                    <CardContent>
                      <p className="text-[hsl(215,10%,40%)] mb-6">
                        Get expert service from Tucson's most trusted home service company serving Tucson Estates. Same-day appointments available!
                      </p>
                      <Button
                        size="lg"
          ...
          <section className="py-16 bg-[hsl(215,70%,25%)] text-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl mb-8 text-white/90" data-testid="final-cta-description">
                Join thousands of satisfied Tucson Estates homeowners. Call us today!
              </p>
              <Button
                size="lg"
                className="bg-[hsl(25,85%,55%)] hover:bg-[hsl(25,85%,45%)] text-white text-lg px-8 py-6"
