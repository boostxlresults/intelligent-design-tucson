...
export default function RoofingCasasAdobes() {
  const description = "Professional roofing services in Casas Adobes, AZ. Expert roof repair, replacement, inspection, coating. Tile, shingle, flat roofs. 24/7 emergency service. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-roofing-casas-adobes.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Roofing Services in Casas Adobes, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Roofing Casas Adobes",
          "item": `${SITE_URL}/roofing-casas-adobes`
        }
      ]
    };
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you offer emergency roof repair in Casas Adobes?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We provide 24/7 emergency roofing services throughout Casas Adobes. Whether it's storm damage, roof leaks, or structural concerns, our licensed roofers respond quickly to minimize interior damage and protect your home."
          }
        },
        {
          "@type": "Question",
          "name": "How quickly can you respond to Casas Adobes roofing emergencies?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For emergency calls in Casas Adobes, we typically arrive within 1-2 hours. Our proximity to Casas Adobes and fully-equipped service vehicles allow us to respond quickly with tarps, temporary repairs, and permanent solutions."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What roofing services do you offer in Casas Adobes?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We provide complete roofing services including emergency repairs, roof replacement and installation, roof inspections, roof coating and sealing, tile roof services, shingle roof services, flat roof repair, leak detection and repair, and preventive maintenance for Casas Adobes homes and businesses."
          }
        },
        {
          "@type": "Question",
          "name": "Do you warranty your roofing work in Casas Adobes?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock emergency roofing for Casas Adobes residents"
    },
    {
      icon: Award,
  ...
  return (
    <>
      <MetaHead
        ...
        description={description}
        canonical={`${SITE_URL}/roofing-casas-adobes`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'Roofing Services Casas Adobes AZ | Professional Roofer' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/roofing-casas-adobes` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'Roofing Services Casas Adobes AZ | Professional Roofer' },
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight" data-testid="heading-hero">
                  Professional Roofing Services in Casas Adobes, AZ
                </h1>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6">
                  Trusted Roofer Serving Casas Adobes Since 1979
                </h2>
                ...
                <div className="bg-[hsl(25,85%,55%)]/5 border-l-4 border-[hsl(25,85%,55%)] p-6 mb-8">
                  <h3 className="text-xl font-bold text-[hsl(215,70%,25%)] mb-3">
                    Why Casas Adobes Homeowners Choose Us
                  </h3>
                  <ul className="space-y-2 text-[hsl(215,10%,30%)]">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-[hsl(25,85%,55%)] flex-shrink-0 mt-0.5" />
                      <span><strong>Fast Service:</strong> Same-day and emergency service throughout Casas Adobes</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-[hsl(25,85%,55%)] flex-shrink-0 mt-0.5" />
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6 mt-12">
                  Complete Roofing Services for Casas Adobes
                </h2>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Local expertise since 1979. We know Casas Adobes roofing systems, climate challenges, and code requirements inside and out.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">BBB A+ rated with thousands of satisfied Casas Adobes customers. Our reputation speaks to our quality and service.</p>
                    </div>
                  </div>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-8 text-center">
                  Casas Adobes Roofing FAQs
                </h2>
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you offer emergency roof repair in Casas Adobes?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Yes! We provide 24/7 emergency roofing services throughout Casas Adobes. Whether it's storm damage, roof leaks, or structural concerns, our licensed roofers respond quickly to minimize interior damage and protect your home.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-2" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      How quickly can you respond to Casas Adobes roofing emergencies?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      For emergency calls in Casas Adobes, we typically arrive within 1-2 hours. Our proximity to Casas Adobes and fully-equipped service vehicles allow us to respond quickly with tarps, temporary repairs, and permanent solutions.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-4" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      What roofing services do you offer in Casas Adobes?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      We provide complete roofing services including emergency repairs, roof replacement and installation, roof inspections, roof coating and sealing, tile roof services, shingle roof services, flat roof repair, leak detection and repair, and preventive maintenance for Casas Adobes homes and businesses.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you warranty your roofing work in Casas Adobes?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
