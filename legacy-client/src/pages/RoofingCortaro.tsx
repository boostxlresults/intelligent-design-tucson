...
export default function RoofingCortaro() {
  const description = "Professional roofing services in Cortaro, AZ. Expert roof repair, replacement, inspection, coating. Tile, shingle, flat roofs. 24/7 emergency service. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-roofing-cortaro.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Roofing Services in Cortaro, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Roofing Cortaro",
          "item": `${SITE_URL}/roofing-cortaro`
        }
      ]
    };
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you offer emergency roof repair in Cortaro?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We provide 24/7 emergency roofing services throughout Cortaro. Whether it's storm damage, roof leaks, or structural concerns, our licensed roofers respond quickly to minimize interior damage and protect your home."
          }
        },
        {
          "@type": "Question",
          "name": "How quickly can you respond to Cortaro roofing emergencies?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For emergency calls in Cortaro, we typically arrive within 1-2 hours. Our proximity to Cortaro and fully-equipped service vehicles allow us to respond quickly with tarps, temporary repairs, and permanent solutions."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What roofing services do you offer in Cortaro?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We provide complete roofing services including emergency repairs, roof replacement and installation, roof inspections, roof coating and sealing, tile roof services, shingle roof services, flat roof repair, leak detection and repair, and preventive maintenance for Cortaro homes and businesses."
          }
        },
        {
          "@type": "Question",
          "name": "Do you warranty your roofing work in Cortaro?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock emergency roofing for Cortaro residents"
    },
    {
      icon: Award,
  ...
  return (
    <>
      <MetaHead
        ...
        description={description}
        canonical={`${SITE_URL}/roofing-cortaro`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'Roofing Services Cortaro AZ | Professional Roofer' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/roofing-cortaro` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'Roofing Services Cortaro AZ | Professional Roofer' },
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight" data-testid="heading-hero">
                  Professional Roofing Services in Cortaro, AZ
                </h1>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6">
                  Trusted Roofer Serving Cortaro Since 1979
                </h2>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6 mt-12">
                  Complete Roofing Services for Cortaro
                </h2>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Local expertise since 1979. We know Cortaro roofing systems, climate challenges, and code requirements inside and out.</p>
                    </div>
                  </div>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-8 text-center">
                  Cortaro Roofing FAQs
                </h2>
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you offer emergency roof repair in Cortaro?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Yes! We provide 24/7 emergency roofing services throughout Cortaro. Whether it's storm damage, roof leaks, or structural concerns, our licensed roofers respond quickly to minimize interior damage and protect your home.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-2" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      How quickly can you respond to Cortaro roofing emergencies?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      For emergency calls in Cortaro, we typically arrive within 1-2 hours. Our proximity to Cortaro and fully-equipped service vehicles allow us to respond quickly with tarps, temporary repairs, and permanent solutions.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-4" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      What roofing services do you offer in Cortaro?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      We provide complete roofing services including emergency repairs, roof replacement and installation, roof inspections, roof coating and sealing, tile roof services, shingle roof services, flat roof repair, leak detection and repair, and preventive maintenance for Cortaro homes and businesses.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you warranty your roofing work in Cortaro?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
