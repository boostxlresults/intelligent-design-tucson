...
export default function HeatingVail() {
  const description = "Professional heating services in Vail, AZ. Furnace repair, installation, maintenance, heat pumps. 24/7 emergency heater service. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-heating-vail.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Heating Services in Vail, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Heating Vail",
          "item": `${SITE_URL}/heating-vail`
        }
      ]
    };

    const schemas = [
      { id: 'service-schema', data: serviceSchema, attr: 'heating-vail-service' },
      { id: 'breadcrumb-schema', data: breadcrumbSchema, attr: 'heating-vail-breadcrumb' },
    ];
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock emergency heating repair for Vail residents"
    },
    {
      icon: Award,
  ...
  return (
    <>
      <MetaHead
        ...
        description={description}
        canonical={`${SITE_URL}/heating-vail`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'Heating Services Vail AZ | Furnace Repair & Installation' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/heating-vail` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'Heating Services Vail AZ | Furnace Repair & Installation' },
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1">
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6">
                  Trusted Heating Company Serving Vail Since 1979
                </h2>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6 mt-12">
                  Complete Heating Services for Vail
                </h2>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Local expertise since 1979. We know Vail heating systems, climate considerations, and efficiency solutions inside and out.</p>
                    </div>
                  </div>
          ...
          <ServiceFAQ faqs={heatingLocationFAQs.faqs} sectionHeading="Vail Heating FAQs" serviceName={heatingLocationFAQs.serviceName} serviceId={heatingLocationFAQs.serviceId} />
