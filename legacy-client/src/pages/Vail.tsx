...
import heroImage from "@assets/generated_images/Vail_Arizona_desert_landscape_74c9ba44.webp";
import { Link } from "wouter";

export default function Vail() {
  const description = "Expert HVAC, plumbing, solar, electrical, roofing, and drain services in Vail. Serving this rural desert community southeast of Tucson since 1979. 24/7 emergency service. BBB A+ rated with 22,000+ five-star reviews.";
  ...
  useEffect(() => {
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you serve Vail, Arizona?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We proudly serve all of Vail and the surrounding areas. Vail is a small unincorporated community southeast of Tucson that we've been serving since 1979. We provide same-day service for HVAC, plumbing, solar, electrical, and roofing needs throughout the community."
          }
        },
        {
          "@type": "Question",
          "name": "What services do you offer in Vail?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "How quickly can you respond to Vail service calls?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We offer fast response times throughout Vail. For emergency calls, we typically arrive within 1-2 hours. For scheduled appointments, we offer same-day and next-day service. Our proximity to Vail allows us to serve you quickly and efficiently."
          }
        },
        {
          "@type": "Question",
          "name": "Do you offer emergency service in Vail?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Absolutely! We provide 24/7 emergency service for HVAC, plumbing, and electrical emergencies in Vail. Whether it's a broken AC in summer heat, a plumbing leak, or an electrical issue, call us anytime at (520) 333-2665 for immediate assistance."
          }
        },
        {
          "@type": "Question",
          "name": "Are you licensed to work in Vail?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What makes you different from other Vail contractors?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We've been serving the Vail area since 1979 with comprehensive warranties, upfront pricing, and 100% satisfaction guarantees. With over 22,000 five-star reviews, our reputation speaks for itself. We're a family-owned business committed to treating your home with the care it deserves."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Can you help with solar installation in Vail?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Definitely! Vail's sunny climate is perfect for solar energy. We offer residential solar panel installations, solar AC systems, and ongoing maintenance. We'll help you maximize federal tax credits and local incentives."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What are your service hours for Vail?",
          "acceptedAnswer": {
            "@type": "Answer",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Vail Services",
          "item": "https://www.idesignac.com/vail"
        }
      ]
    };
  ...
  const services = [
    {
      ...
      description: "Expert AC repair, installation, and maintenance for Vail's extreme heat.",
      link: "/hvac-vail"
    },
    {
      icon: Flame,
    ...
    },
    {
      icon: Sun,
      title: "Solar",
      description: "Professional solar panel installation and maintenance for Vail homes.",
      link: "/solar-installation-vail"
    },
    {
      icon: Zap,
      title: "Electrical",
      description: "Licensed electrical services including panel upgrades and repairs.",
      link: "/electrical-vail"
    },
    {
      icon: HomeIcon,
      title: "Roofing",
  ...
  return (
    <>
      <MetaHead
        ...
        canonical="https://www.idesignac.com/vail"
        openGraph={[
          { property: 'og:title', content: 'HVAC, Plumbing, Solar, Electrical & Roofing Services in Vail, AZ | Intelligent Design' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: 'https://www.idesignac.com/vail' },
          { property: 'og:type', content: 'website' },
          { property: 'og:site_name', content: 'Intelligent Design' },
          { property: 'og:locale', content: 'en_US' },
          { property: 'og:image:width', content: '1200' },
          { property: 'og:image:height', content: '630' },
          { property: 'og:image:alt', content: 'Vail Arizona desert landscape' }
        ]}
        twitter={[
          { name: 'twitter:card', content: 'summary_large_image' },
          { name: 'twitter:title', content: 'HVAC, Plumbing, Solar, Electrical & Roofing Services in Vail, AZ | Intelligent Design' },
          { name: 'twitter:description', content: description },
          { name: 'twitter:image', content: imageUrl },
          { name: 'twitter:image:alt', content: 'Vail Arizona desert landscape' }
        ]}
      />
      <GTM />
      <DNIInjector />
        ...
        <main className="flex-1">
          ...
          <section className="relative min-h-[600px] md:min-h-[700px] flex items-center">
            <div className="absolute inset-0 z-0">
              <img
                src={heroImage}
                alt="Vail Arizona desert landscape with mountains"
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6" data-testid="hero-title">
                  HVAC, Plumbing, Solar, Electrical & Roofing Services in Vail, AZ
                </h1>
                <p className="text-xl md:text-2xl text-white/90 mb-4" data-testid="hero-subtitle">
                  Serving Vail's Rural Desert Community
                </p>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6" data-testid="intro-title">
                  Proud to Serve Vail, Arizona
                </h2>
                <p className="text-lg text-[hsl(215,10%,40%)] mb-6" data-testid="intro-description">
                  Since 1979, Intelligent Design has been serving Vail families with expert HVAC, plumbing, solar, electrical, roofing, and drain services. We understand the unique needs of this rural desert community southeast of Tucson.
                </p>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-4" data-testid="services-title">
                  Complete Home Services in Vail
                </h2>
          ...
          <section className="py-16 md:py-20 bg-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6" data-testid="about-vail-title">
                  About Vail, Arizona
                </h2>
                <p className="text-lg text-[hsl(215,10%,40%)] mb-6" data-testid="about-vail-description">
                  Vail is a small unincorporated community southeast of Tucson with a rural desert setting and a close-knit community atmosphere. Known for its scenic mountain views and peaceful lifestyle, Vail offers residents a quiet retreat while maintaining convenient access to Tucson's amenities.
                </p>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    <h4 className="text-xl font-bold text-[hsl(215,70%,25%)] mb-2" data-testid="feature-open-spaces-title">
                      Open Spaces & Desert Landscape
                    </h4>
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-open-spaces-description">
                      Vail features wide open spaces and beautiful desert landscapes that provide residents with privacy and stunning natural scenery. The area's rural character makes it ideal for those seeking a quieter lifestyle.
                    </p>
                  </div>
                  
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    <h4 className="text-xl font-bold text-[hsl(215,70%,25%)] mb-2" data-testid="feature-saguaro-title">
                      Proximity to Saguaro National Park East
                    </h4>
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-saguaro-description">
                      Located near Saguaro National Park East, Vail residents enjoy easy access to world-class hiking, wildlife viewing, and outdoor recreation opportunities. The iconic saguaro cacti and desert trails are just minutes away.
                    </p>
                  </div>
                  
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    <h4 className="text-xl font-bold text-[hsl(215,70%,25%)] mb-2" data-testid="feature-equestrian-title">
                      Equestrian-Friendly Community
                    </h4>
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-equestrian-description">
                      With larger properties and a rural setting, Vail is popular among horse enthusiasts. Many properties feature equestrian facilities, and the area's wide-open spaces are perfect for riding and enjoying the Arizona desert.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="bg-white rounded-lg px-6" data-testid="faq-item-1">
                    <AccordionTrigger className="text-left font-semibold">
                      Do you serve Vail, Arizona?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Yes! We proudly serve all of Vail and the surrounding areas. Vail is a small unincorporated community southeast of Tucson that we've been serving since 1979. We provide same-day service for HVAC, plumbing, solar, electrical, and roofing needs throughout the community.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-2" className="bg-white rounded-lg px-6" data-testid="faq-item-2">
                    <AccordionTrigger className="text-left font-semibold">
                      What services do you offer in Vail?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <AccordionItem value="item-3" className="bg-white rounded-lg px-6" data-testid="faq-item-3">
                    <AccordionTrigger className="text-left font-semibold">
                      How quickly can you respond to Vail service calls?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      We offer fast response times throughout Vail. For emergency calls, we typically arrive within 1-2 hours. For scheduled appointments, we offer same-day and next-day service. Our proximity to Vail allows us to serve you quickly and efficiently.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-4" className="bg-white rounded-lg px-6" data-testid="faq-item-4">
                    <AccordionTrigger className="text-left font-semibold">
                      Do you offer emergency service in Vail?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Absolutely! We provide 24/7 emergency service for HVAC, plumbing, and electrical emergencies in Vail. Whether it's a broken AC in summer heat, a plumbing leak, or an electrical issue, call us anytime at (520) 333-2665 for immediate assistance.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="bg-white rounded-lg px-6" data-testid="faq-item-5">
                    <AccordionTrigger className="text-left font-semibold">
                      Are you licensed to work in Vail?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <AccordionItem value="item-6" className="bg-white rounded-lg px-6" data-testid="faq-item-6">
                    <AccordionTrigger className="text-left font-semibold">
                      What makes you different from other Vail contractors?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      We've been serving the Vail area since 1979 with comprehensive warranties, upfront pricing, and 100% satisfaction guarantees. With over 22,000 five-star reviews, our reputation speaks for itself. We're a family-owned business committed to treating your home with the care it deserves.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-8" className="bg-white rounded-lg px-6" data-testid="faq-item-8">
                    <AccordionTrigger className="text-left font-semibold">
                      Can you help with solar installation in Vail?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Definitely! Vail's sunny climate is perfect for solar energy. We offer residential solar panel installations, solar AC systems, and ongoing maintenance. We'll help you maximize federal tax credits and local incentives.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-10" className="bg-white rounded-lg px-6" data-testid="faq-item-10">
                    <AccordionTrigger className="text-left font-semibold">
                      What are your service hours for Vail?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <Card data-testid="scheduler-card">
                    ...
                    <CardContent>
                      <p className="text-[hsl(215,10%,40%)] mb-6">
                        Get expert service from Tucson's most trusted home service company serving Vail. Same-day appointments available!
                      </p>
                      <Button
                        size="lg"
          ...
          <section className="py-16 bg-[hsl(215,70%,25%)] text-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl mb-8 text-white/90" data-testid="final-cta-description">
                Join thousands of satisfied Vail homeowners. Call us today!
              </p>
              <Button
                size="lg"
                className="bg-[hsl(25,85%,55%)] hover:bg-[hsl(25,85%,45%)] text-white text-lg px-8 py-6"
