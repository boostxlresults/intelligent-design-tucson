...
export default function RoofingCoronadeTucson() {
  const description = "Professional roofing services in Corona de Tucson, AZ. Expert roof repair, replacement, inspection, coating. Tile, shingle, flat roofs. 24/7 emergency service. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-roofing-corona-de-tucson.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Roofing Services in Corona de Tucson, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Roofing Corona de Tucson",
          "item": `${SITE_URL}/roofing-corona-de-tucson`
        }
      ]
    };
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you offer emergency roof repair in Corona de Tucson?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We provide 24/7 emergency roofing services throughout Corona de Tucson. Whether it's storm damage, roof leaks, or structural concerns, our licensed roofers respond quickly to minimize interior damage and protect your home."
          }
        },
        {
          "@type": "Question",
          "name": "How quickly can you respond to Corona de Tucson roofing emergencies?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For emergency calls in Corona de Tucson, we typically arrive within 1-2 hours. Our proximity to Corona de Tucson and fully-equipped service vehicles allow us to respond quickly with tarps, temporary repairs, and permanent solutions."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What roofing services do you offer in Corona de Tucson?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We provide complete roofing services including emergency repairs, roof replacement and installation, roof inspections, roof coating and sealing, tile roof services, shingle roof services, flat roof repair, leak detection and repair, and preventive maintenance for Corona de Tucson homes and businesses."
          }
        },
        {
          "@type": "Question",
          "name": "Do you warranty your roofing work in Corona de Tucson?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock emergency roofing for Corona de Tucson residents"
    },
    {
      icon: Award,
  ...
  return (
    <>
      <MetaHead
        title="Roofing Services Corona de Tucson AZ | Professional Roofer"
        description={description}
        canonical={`${SITE_URL}/roofing-corona-de-tucson`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'Roofing Services Corona de Tucson AZ | Professional Roofer' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/roofing-corona-de-tucson` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'Roofing Services Corona de Tucson AZ | Professional Roofer' },
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight" data-testid="heading-hero">
                  Professional Roofing Services in Corona de Tucson, AZ
                </h1>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6">
                  Trusted Roofer Serving Corona de Tucson Since 1979
                </h2>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                  When your Corona de Tucson roof needs attention, you need experienced roofers you can trust. At Intelligent Design, we've been providing expert roofing services to Corona de Tucson families and businesses since 1979. Our licensed, bonded, and insured roofing professionals deliver reliable solutions for everything from emergency leak repairs to complete roof replacements, backed by our 100% satisfaction guarantee and BBB A+ rating.
                </p>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                  Corona de Tucson's intense sun exposure and monsoon weather create unique challenges for roofing systems. Our technicians understand how UV radiation degrades roofing materials, how thermal cycling causes tiles to crack, and how summer storms can expose vulnerable areas. We stay current with Town of Corona de Tucson building codes and use materials specifically rated for Arizona's harsh desert climate.
                </p>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6 mt-12">
                  Complete Roofing Services for Corona de Tucson
                </h2>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                  <strong>Emergency Roof Repair</strong> - Roofing emergencies don't wait for business hours. Our 24/7 emergency roofers respond quickly to storm damage, severe leaks, structural concerns, and wind damage throughout Corona de Tucson. We arrive with tarps, tools, and materials to provide temporary protection and permanent repairs, minimizing interior water damage to your home.
                </p>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                  <strong>Roof Replacement & Installation</strong> - From traditional tile roofs to modern shingle systems, we handle all roof replacement needs. Our services include professional removal of old roofing, proper deck preparation and repair, expert installation using quality materials, compliance with local building codes, and thorough cleanup. We help Corona de Tucson homeowners select roofing materials that provide maximum protection, energy efficiency, and curb appeal.
                </p>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                  <strong>Roof Inspection & Coating</strong> - Regular inspections extend roof life and prevent costly damage. We provide comprehensive roof inspections with detailed reports, professional roof coating to seal and protect, preventive maintenance to address small issues, and thermal imaging to detect hidden moisture. Our maintenance programs keep Corona de Tucson roofing systems performing optimally year after year.
                </p>
                <p className="text-lg mb-8 text-[hsl(215,10%,30%)]">
                  <strong>Tile & Specialty Roofing</strong> - Arizona's architectural heritage features distinctive tile roofing that requires specialized knowledge. Our tile roofing expertise includes cracked tile replacement, underlayment repair, proper tile fitting and sealing, and color-matched tiles for seamless repairs. We preserve the beauty and integrity of Corona de Tucson's tile roofs while ensuring maximum weather protection.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Local expertise since 1979. We know Corona de Tucson roofing systems, climate challenges, and code requirements inside and out.</p>
                    </div>
                  </div>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-8 text-center">
                  Corona de Tucson Roofing FAQs
                </h2>
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you offer emergency roof repair in Corona de Tucson?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Yes! We provide 24/7 emergency roofing services throughout Corona de Tucson. Whether it's storm damage, roof leaks, or structural concerns, our licensed roofers respond quickly to minimize interior damage and protect your home.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-2" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      How quickly can you respond to Corona de Tucson roofing emergencies?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      For emergency calls in Corona de Tucson, we typically arrive within 1-2 hours. Our proximity to Corona de Tucson and fully-equipped service vehicles allow us to respond quickly with tarps, temporary repairs, and permanent solutions.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-4" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      What roofing services do you offer in Corona de Tucson?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      We provide complete roofing services including emergency repairs, roof replacement and installation, roof inspections, roof coating and sealing, tile roof services, shingle roof services, flat roof repair, leak detection and repair, and preventive maintenance for Corona de Tucson homes and businesses.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you warranty your roofing work in Corona de Tucson?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
          ...
          <section className="py-16 bg-[hsl(215,70%,25%)] text-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Need a Roofer in Corona de Tucson?
              </h2>
