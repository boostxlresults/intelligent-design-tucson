...
import heroImage from "@assets/generated_images/HVAC_tech_with_diagnostic_tools_7049f29a.webp";

export default function HVACEastTucson() {
  const description = "Expert HVAC & air conditioning services in East Tucson, AZ. AC repair, installation, maintenance, ductless mini-splits, heat pumps. 24/7 emergency service. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-hvac-east-tucson.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "HVAC & Air Conditioning Services in East Tucson, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "HVAC East Tucson",
          "item": `${SITE_URL}/hvac-east-tucson`
        }
      ]
    };

    const schemas = [
      { id: 'service-schema', data: serviceSchema, attr: 'hvac-east-tucson-service' },
      { id: 'breadcrumb-schema', data: breadcrumbSchema, attr: 'hvac-east-tucson-breadcrumb' },
    ];
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock emergency AC repair for East Tucson residents"
    },
    {
      icon: Award,
  ...
  return (
    <>
      <MetaHead
        ...
        description={description}
        canonical={`${SITE_URL}/hvac-east-tucson`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'HVAC & AC Services East Tucson AZ | Air Conditioning Repair & Installation' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/hvac-east-tucson` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'HVAC & AC Services East Tucson AZ | Air Conditioning Repair & Installation' },
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1">
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight" data-testid="heading-hero">
                  HVAC & Air Conditioning Services in East Tucson, AZ
                </h1>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6">
                  Trusted HVAC Company Serving East Tucson Since 1979
                </h2>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6 mt-12">
                  Complete HVAC Services for East Tucson
                </h2>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                ...
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                  <strong>AC Installation & Replacement</strong> - From single-stage systems to variable-speed units, we install all types of air conditioning equipment. Our services include professional load calculations, proper sizing for East Tucson homes, high-efficiency system selection, expert installation following manufacturer specs, and refrigerant charging for optimal performance. We help homeowners maximize federal tax credits and utility rebates.
                </p>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Local expertise since 1979. We know East Tucson HVAC systems, climate challenges, and energy efficiency solutions inside and out.</p>
                    </div>
                  </div>
          ...
          <ServiceFAQ faqs={hvacLocationFAQs.faqs} sectionHeading="East Tucson HVAC FAQs" serviceName={hvacLocationFAQs.serviceName} serviceId={hvacLocationFAQs.serviceId} />
          ...
          <section className="py-16 bg-[hsl(215,70%,25%)] text-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Need HVAC Service in East Tucson?
              </h2>
