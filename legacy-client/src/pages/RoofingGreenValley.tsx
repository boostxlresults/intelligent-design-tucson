...
export default function RoofingGreenValley() {
  const description = "Professional roofing services in Green Valley, AZ. Expert roof repair, replacement, inspection, coating. Tile, shingle, flat roofs. 24/7 emergency service. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-roofing-green-valley.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Roofing Services in Green Valley, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Roofing Green Valley",
          "item": `${SITE_URL}/roofing-green-valley`
        }
      ]
    };
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you offer emergency roof repair in Green Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We provide 24/7 emergency roofing services throughout Green Valley. Whether it's storm damage, roof leaks, or structural concerns, our licensed roofers respond quickly to minimize interior damage and protect your home."
          }
        },
        {
          "@type": "Question",
          "name": "How quickly can you respond to Green Valley roofing emergencies?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For emergency calls in Green Valley, we typically arrive within 1-2 hours. Our proximity to Green Valley and fully-equipped service vehicles allow us to respond quickly with tarps, temporary repairs, and permanent solutions."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What roofing services do you offer in Green Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We provide complete roofing services including emergency repairs, roof replacement and installation, roof inspections, roof coating and sealing, tile roof services, shingle roof services, flat roof repair, leak detection and repair, and preventive maintenance for Green Valley homes and businesses."
          }
        },
        {
          "@type": "Question",
          "name": "Do you warranty your roofing work in Green Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock emergency roofing for Green Valley residents"
    },
    {
      icon: Award,
  ...
  return (
    <>
      <MetaHead
        title="Roofing Services Green Valley AZ | Professional Roofer"
        description={description}
        canonical={`${SITE_URL}/roofing-green-valley`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'Roofing Services Green Valley AZ | Professional Roofer' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/roofing-green-valley` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'Roofing Services Green Valley AZ | Professional Roofer' },
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight" data-testid="heading-hero">
                  Professional Roofing Services in Green Valley, AZ
                </h1>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6">
                  Trusted Roofer Serving Green Valley Since 1979
                </h2>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                  When your Green Valley roof needs attention, you need experienced roofers you can trust. At Intelligent Design, we've been providing expert roofing services to Green Valley families and businesses since 1979. Our licensed, bonded, and insured roofing professionals deliver reliable solutions for everything from emergency leak repairs to complete roof replacements, backed by our 100% satisfaction guarantee and BBB A+ rating.
                </p>
                <p className="text-lg mb-6 text-[hsl(215,10%,30%)]">
                  Green Valley's intense sun exposure and monsoon weather create unique challenges for roofing systems. Our technicians understand how UV radiation degrades roofing materials, how thermal cycling causes tiles to crack, and how summer storms can expose vulnerable areas. We stay current with Town of Green Valley building codes and use materials specifically rated for Arizona's harsh desert climate.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="flex gap-3 items-start bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Local expertise since 1979. We know Green Valley roofing systems, climate challenges, and code requirements inside and out.</p>
                    </div>
                  </div>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-8 text-center">
                  Green Valley Roofing FAQs
                </h2>
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you offer emergency roof repair in Green Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Yes! We provide 24/7 emergency roofing services throughout Green Valley. Whether it's storm damage, roof leaks, or structural concerns, our licensed roofers respond quickly to minimize interior damage and protect your home.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-2" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      How quickly can you respond to Green Valley roofing emergencies?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      For emergency calls in Green Valley, we typically arrive within 1-2 hours. Our proximity to Green Valley and fully-equipped service vehicles allow us to respond quickly with tarps, temporary repairs, and permanent solutions.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-4" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      What roofing services do you offer in Green Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      We provide complete roofing services including emergency repairs, roof replacement and installation, roof inspections, roof coating and sealing, tile roof services, shingle roof services, flat roof repair, leak detection and repair, and preventive maintenance for Green Valley homes and businesses.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you warranty your roofing work in Green Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
