...
export default function ElectricalOroValley() {
  const description = "Licensed electrician in Oro Valley, AZ. Electrical repairs, panel upgrades, generator installation, lighting, outlets. 24/7 emergency service. BBB A+ rated.";
  const imageUrl = `${SITE_URL}/og-electrical-oro-valley.jpg`;

  useEffect(() => {
    const serviceSchema = {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Electrical Services in Oro Valley, AZ",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Electrical Oro Valley",
          "item": `${SITE_URL}/electrical-oro-valley`
        }
      ]
    };
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you offer emergency electrical service in Oro Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We provide 24/7 emergency electrical services throughout Oro Valley. Our licensed electricians respond quickly to power outages, sparking outlets, burning smells, and other dangerous electrical emergencies to keep your family safe."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What electrical services do you provide in Oro Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We provide complete electrical services including emergency repairs, panel upgrades, generator installation, ceiling fan installation, lighting upgrades, outlet and switch replacement, circuit breaker service, and electrical inspections for Oro Valley homes and businesses."
          }
        },
        {
          "@type": "Question",
          "name": "How much does a panel upgrade cost in Oro Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Panel upgrade costs vary based on amperage and complexity. Most Oro Valley residential panel upgrades range from $1,500-$3,500. We provide free estimates and can assess your needs during a consultation to give you an accurate quote."
          }
        },
        {
          "@type": "Question",
          "name": "Do you install Generac generators in Oro Valley?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We're authorized Generac dealers providing professional generator installation throughout Oro Valley. We handle sizing, permitting, installation, and ongoing maintenance to ensure reliable backup power during outages."
          }
        }
      ]
    };
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock emergency electrical for Oro Valley residents"
    },
    {
      icon: Award,
  ...
  return (
    <>
      <MetaHead
        title="Electrician Oro Valley AZ | Licensed Electrical Services"
        description={description}
        canonical={`${SITE_URL}/electrical-oro-valley`}
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'Electrician Oro Valley AZ | Licensed Electrical Services' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: `${SITE_URL}/electrical-oro-valley` },
        ...
        twitter={[
          ...
          { name: 'twitter:title', content: 'Electrician Oro Valley AZ | Licensed Electrical Services' },
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight" data-testid="heading-hero">
                  Licensed Electrician in Oro Valley, AZ
                </h1>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6">
                  Trusted Electrician Serving Oro Valley Since 1979
                </h2>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-8 text-center">
                  Oro Valley Electrical FAQs
                </h2>
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      Do you offer emergency electrical service in Oro Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      Yes! We provide 24/7 emergency electrical services throughout Oro Valley. Our licensed electricians respond quickly to power outages, sparking outlets, burning smells, and other dangerous electrical emergencies to keep your family safe.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-3" className="border rounded-lg px-6 bg-white">
                    <AccordionTrigger className="text-left font-semibold hover:no-underline">
                      What electrical services do you provide in Oro Valley?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,30%)]">
                      We provide complete electrical services including emergency repairs, panel upgrades, generator installation, ceiling fan installation, lighting upgrades, outlet and switch replacement, circuit breaker service, and electrical inspections for Oro Valley homes and businesses.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </div>
          ...
          <section className="py-16 bg-[hsl(215,70%,25%)] text-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Need an Electrician in Oro Valley?
              </h2>
