...
import heroImage from "@assets/generated_images/Casas_Adobes_Arizona_neighborhood_ec16d681.webp";
import { Link } from "wouter";

export default function CasasAdobes() {
  const description = "Expert HVAC, plumbing, solar, electrical, roofing, and drain services in Casas Adobes. Serving this vibrant community north of Tucson since 1979. 24/7 emergency service. BBB A+ rated with 22,000+ five-star reviews.";
  ...
  useEffect(() => {
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you serve Casas Adobes, Arizona?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We proudly serve all of Casas Adobes and the surrounding areas. Casas Adobes is a vibrant community north of Tucson that we've been serving since 1979. We provide same-day service for HVAC, plumbing, solar, electrical, and roofing needs throughout the community."
          }
        },
        {
          "@type": "Question",
          "name": "What services do you offer in Casas Adobes?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "How quickly can you respond to Casas Adobes service calls?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We offer fast response times throughout Casas Adobes. For emergency calls, we typically arrive within 1-2 hours. For scheduled appointments, we offer same-day and next-day service. Our proximity to Casas Adobes allows us to serve you quickly and efficiently."
          }
        },
        {
          "@type": "Question",
          "name": "Do you offer emergency service in Casas Adobes?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Absolutely! We provide 24/7 emergency service for HVAC, plumbing, and electrical emergencies in Casas Adobes. Whether it's a broken AC in summer heat, a plumbing leak, or an electrical issue, call us anytime at (520) 333-2665 for immediate assistance."
          }
        },
        {
          "@type": "Question",
          "name": "Are you licensed to work in Casas Adobes?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What makes you different from other Casas Adobes contractors?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We've been serving the Casas Adobes area since 1979 with comprehensive warranties, upfront pricing, and 100% satisfaction guarantees. With over 22,000 five-star reviews, our reputation speaks for itself. We're a family-owned business committed to treating your home with the care it deserves."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Can you help with solar installation in Casas Adobes?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Definitely! Casas Adobes' sunny climate is perfect for solar energy. We offer residential solar panel installations, solar AC systems, and ongoing maintenance. We'll help you maximize federal tax credits and local incentives."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "What are your service hours for Casas Adobes?",
          "acceptedAnswer": {
            "@type": "Answer",
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.idesignac.com/casas-adobes"
        }
      ]
    };
  ...
  const services = [
    {
      ...
      description: "Expert AC repair, installation, and maintenance for Casas Adobes' extreme heat.",
      link: "/hvac-casas-adobes"
    },
    {
      icon: Flame,
      title: "Heating",
      description: "Reliable heating services to keep you warm during chilly desert nights.",
      link: "/heating-casas-adobes"
    },
    {
      icon: Droplet,
      title: "Plumbing",
      description: "Complete plumbing services from leak repairs to water heater installations.",
      link: "/plumbing-casas-adobes"
    },
    {
      icon: Sun,
      title: "Solar",
      description: "Professional solar panel installation and maintenance for Casas Adobes homes.",
      link: "/solar-installation-casas-adobes"
    },
    {
      icon: Zap,
      title: "Electrical",
      description: "Licensed electrical services including panel upgrades and repairs.",
      link: "/electrical-casas-adobes"
    },
    {
      icon: HomeIcon,
      title: "Roofing",
      description: "Expert roof repair, installation, and coating services for Arizona homes.",
      link: "/roofing-casas-adobes"
    },
    {
      icon: Wrench,
      title: "Drain & Sewer",
  ...
  return (
    <>
      <MetaHead
        ...
        canonical="https://www.idesignac.com/casas-adobes"
        robots="index, follow, max-image-preview:large"
        openGraph={[
          { property: 'og:title', content: 'HVAC, Plumbing, Solar, Electrical & Roofing Services in Casas Adobes, AZ | Intelligent Design' },
          { property: 'og:description', content: description },
          { property: 'og:image', content: imageUrl },
          { property: 'og:url', content: 'https://www.idesignac.com/casas-adobes' },
          { property: 'og:type', content: 'website' },
          { property: 'og:site_name', content: 'Intelligent Design' },
          { property: 'og:locale', content: 'en_US' },
          { property: 'og:image:width', content: '1200' },
          { property: 'og:image:height', content: '630' },
          { property: 'og:image:alt', content: 'Casas Adobes Arizona neighborhood' }
        ]}
        twitter={[
          { name: 'twitter:card', content: 'summary_large_image' },
          { name: 'twitter:title', content: 'HVAC, Plumbing, Solar, Electrical & Roofing Services in Casas Adobes, AZ | Intelligent Design' },
          { name: 'twitter:description', content: description },
          { name: 'twitter:image', content: imageUrl },
          { name: 'twitter:image:alt', content: 'Casas Adobes Arizona neighborhood' }
        ]}
      />
      <GTM />
      <DNIInjector />
        ...
        <main className="flex-1">
          ...
          <section className="relative min-h-[600px] md:min-h-[700px] flex items-center">
            <div className="absolute inset-0 z-0">
              <img
                src={heroImage}
                alt="Casas Adobes Arizona neighborhood"
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6" data-testid="hero-title">
                  HVAC, Plumbing, Solar, Electrical & Roofing Services in Casas Adobes, AZ
                </h1>
                <p className="text-xl md:text-2xl text-white/90 mb-4" data-testid="hero-subtitle">
                  Serving Casas Adobes' Vibrant Community
                </p>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6" data-testid="intro-title">
                  Proud to Serve Casas Adobes, Arizona
                </h2>
                <p className="text-lg text-[hsl(215,10%,40%)] mb-6" data-testid="intro-description">
                  Since 1979, Intelligent Design has been serving Casas Adobes families with expert HVAC, plumbing, solar, electrical, roofing, and drain services. We understand the unique needs of this vibrant community north of Tucson.
                </p>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-4" data-testid="services-title">
                  Complete Home Services in Casas Adobes
                </h2>
          ...
          {/* About Casas Adobes Section */}
          <section className="py-16 md:py-20 bg-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-[hsl(215,70%,25%)] mb-6" data-testid="about-area-title">
                  About Casas Adobes, Arizona
                </h2>
                <p className="text-lg text-[hsl(215,10%,40%)] mb-6" data-testid="about-area-description">
                  Casas Adobes is a vibrant unincorporated community north of Tucson, known for its excellent shopping, dining, and recreational amenities. This bustling area combines suburban convenience with a diverse, welcoming atmosphere.
                </p>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    <h4 className="text-xl font-bold text-[hsl(215,70%,25%)] mb-2" data-testid="feature-1-title">
                      Shopping & Entertainment Hub
                    </h4>
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-1-description">
                      Casas Adobes Plaza and surrounding commercial centers offer residents exceptional shopping, dining, and entertainment options. The area features everything from major retailers to local boutiques and restaurants.
                    </p>
                  </div>
                  ...
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    ...
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-2-description">
                      The community boasts numerous parks, trails, and recreational facilities including the popular Tohono Chul Park botanical garden. Residents enjoy year-round outdoor activities with Catalina State Park nearby.
                    </p>
                  </div>
                  ...
                  <div className="border-l-4 border-[hsl(25,85%,55%)] pl-6">
                    ...
                    <p className="text-[hsl(215,10%,40%)]" data-testid="feature-3-description">
                      Strategically located with easy access to I-10 and Oracle Road, Casas Adobes provides quick connections to downtown Tucson, Oro Valley, and surrounding areas. This central location makes commuting convenient for residents.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="bg-white rounded-lg px-6" data-testid="faq-item-1">
                    <AccordionTrigger className="text-left font-semibold">
                      Do you serve Casas Adobes, Arizona?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Yes! We proudly serve all of Casas Adobes and the surrounding areas. Casas Adobes is a vibrant community north of Tucson that we've been serving since 1979. We provide same-day service for HVAC, plumbing, solar, electrical, and roofing needs throughout the community.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-2" className="bg-white rounded-lg px-6" data-testid="faq-item-2">
                    <AccordionTrigger className="text-left font-semibold">
                      What services do you offer in Casas Adobes?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <AccordionItem value="item-3" className="bg-white rounded-lg px-6" data-testid="faq-item-3">
                    <AccordionTrigger className="text-left font-semibold">
                      How quickly can you respond to Casas Adobes service calls?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      We offer fast response times throughout Casas Adobes. For emergency calls, we typically arrive within 1-2 hours. For scheduled appointments, we offer same-day and next-day service. Our proximity to Casas Adobes allows us to serve you quickly and efficiently.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-4" className="bg-white rounded-lg px-6" data-testid="faq-item-4">
                    <AccordionTrigger className="text-left font-semibold">
                      Do you offer emergency service in Casas Adobes?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Absolutely! We provide 24/7 emergency service for HVAC, plumbing, and electrical emergencies in Casas Adobes. Whether it's a broken AC in summer heat, a plumbing leak, or an electrical issue, call us anytime at (520) 333-2665 for immediate assistance.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="bg-white rounded-lg px-6" data-testid="faq-item-5">
                    <AccordionTrigger className="text-left font-semibold">
                      Are you licensed to work in Casas Adobes?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <AccordionItem value="item-6" className="bg-white rounded-lg px-6" data-testid="faq-item-6">
                    <AccordionTrigger className="text-left font-semibold">
                      What makes you different from other Casas Adobes contractors?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      We've been serving the Casas Adobes area since 1979 with comprehensive warranties, upfront pricing, and 100% satisfaction guarantees. With over 22,000 five-star reviews, our reputation speaks for itself. We're a family-owned business committed to treating your home with the care it deserves.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-8" className="bg-white rounded-lg px-6" data-testid="faq-item-8">
                    <AccordionTrigger className="text-left font-semibold">
                      Can you help with solar installation in Casas Adobes?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                      Definitely! Casas Adobes' sunny climate is perfect for solar energy. We offer residential solar panel installations, solar AC systems, and ongoing maintenance. We'll help you maximize federal tax credits and local incentives.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-10" className="bg-white rounded-lg px-6" data-testid="faq-item-10">
                    <AccordionTrigger className="text-left font-semibold">
                      What are your service hours for Casas Adobes?
                    </AccordionTrigger>
                    <AccordionContent className="text-[hsl(215,10%,40%)]">
                  ...
                  <Card data-testid="scheduler-card">
                    ...
                    <CardContent>
                      <p className="text-[hsl(215,10%,40%)] mb-6">
                        Get expert service from Tucson's most trusted home service company serving Casas Adobes. Same-day appointments available!
                      </p>
                      <Button
                        size="lg"
          ...
          <section className="py-16 bg-[hsl(215,70%,25%)] text-white">
            <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl mb-8 text-white/90" data-testid="final-cta-description">
                Join thousands of satisfied Casas Adobes homeowners. Call us today!
              </p>
              <Button
                size="lg"
                className="bg-[hsl(25,85%,55%)] hover:bg-[hsl(25,85%,45%)] text-white text-lg px-8 py-6"
