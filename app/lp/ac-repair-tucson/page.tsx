    ...
    <>
      ...
      <section className="px-4 py-9">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-lg text-muted-foreground">Fast, honest <strong>AC repair</strong> in <strong>Tucson</strong> with up-front pricing - most repairs done same day.</p>
      ...
      <section className="px-4 py-10">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-lg mt-3 max-w-none text-muted-foreground">
            <p>When your air conditioner fails in a Tucson summer, you don&rsquo;t need a sales pitch - you need it fixed. Our technicians diagnose the actual problem, show you the failed part, and give you an exact price before touching anything. Most <strong>AC repairs in Tucson</strong> are finished the same day because our trucks are stocked with the parts that fail most often in desert heat.</p>
            ...
            <p>We charge fair, up-front pricing with <strong>no overtime rates</strong>, and the diagnostic and estimate fee is waived when you move forward with the repair. Our technicians are background-checked and non-commissioned, so you get an honest recommendation - a real repair when a repair makes sense, not a push to replace a system that has years left. We service all major brands, back our work with a warranty, and have earned 23,000+ five-star reviews across Tucson since 1979.</p>
