    ...
    <>
      ...
      <section className="bg-[#0d1b3e] px-4 py-8 text-center text-white">
        <div className="mx-auto max-w-2xl">
          ...
          <h1 className="mt-3 text-4xl font-extrabold leading-tight sm:text-5xl">Emergency AC Repair in Tucson - Same Day</h1>
      ...
      <section className="bg-[#0d1b3e] px-4 py-10 text-center text-white">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-3xl font-extrabold">Don&rsquo;t sit in the heat - call now</h2>
