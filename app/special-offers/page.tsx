...
export default function SpecialOffersPage() {
  ...
  const offers = [
    ...
    {
      id: 'drain-clearing',
      title: '$28.88 Drain Clearing Special',
      ...
      link: '/drain-clearing-special',
    },
    {
      id: 'roof-inspection',
      title: 'Free Roof Inspection',
      description: 'Get a comprehensive roof inspection at no cost. Our experts will assess your roof condition and provide recommendations.',
      price: 'FREE',
      badge: 'No Obligation',
      features: [
    ...
    {
      id: 'hvac-quote',
      title: 'Free Online HVAC Quote',
      description: 'Get an instant quote for your new air conditioning or heating system. No waiting, no pressure.',
      price: 'FREE',
      badge: 'Instant Quote',
      features: [
      ...
      cta: 'Get Free Quote',
      link: '/free-hvac-quote',
    },
    {
      id: 'water-heater-quote',
      title: 'Free Online Water Heater Quote',
      description: 'Get an instant quote for water heater repair or replacement. Compare options and pricing online.',
      price: 'FREE',
      badge: 'Instant Quote',
      features: [
        'Instant online pricing',
