...
export default function KnowledgeHubPage() {
  const featuredResources: ResourceCategory[] = [
    ...
    },
    {
      ...
      description: 'Current specials including $88.88 HVAC Tune-Up, $48.88 Drain Clearing, free roof inspections, free online quotes, solar consultations, and flexible financing options.',
      icon: DollarSign,
      href: '/special-offers',
      color: 'text-primary',
    },
