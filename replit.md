...
## Overview
This project is a conversion-focused marketing website for Intelligent Design, a family and veteran-owned home services company in Tucson, Arizona. The site drives service bookings for HVAC, plumbing, solar, electrical, roofing, and drain/sewer services through ServiceTitan integration, builds trust via social proof, optimizes for local SEO, and provides a mobile-first experience. The project's ambition is to build the highest-ranking AI-search and conversion-optimized service site in the country through comprehensive location+service matrix coverage and advanced zip code SEO integration. The current site includes over 488 pages, with 268 service pages (including 140 location-specific service pages), 20 service area pages, 231 optimized blog posts, dedicated resource pages, promotional offer pages, three Contractor Commerce integration pages, and career opportunities integration. Deployment: Replit → GitHub → Vercel → **https://www.idesignac.com/**
...
- **Service Pages:** Template includes full-width background hero, 6 highlight cards, extensive service content, review module, and comprehensive FAQ section (minimum 11 questions). CTA sections now support both ServiceTitan scheduler integration and external link CTAs for cross-page conversion optimization.
...
- **Cross-Page Conversion CTAs:** Strategic CTA buttons linking HVAC installation pages (ac-installation-tucson, heater-installation-tucson) to /free-hvac-quote and water heater pages (water-heaters, water-heater-repair, water-heater-installation, hybrid-water-heaters, water-heater-flush) to /water-heater-quote, creating conversion funnels from service pages to Contractor Commerce quote tools.
...
- **Contractor Commerce Integration Pages:** Three interactive quote/shopping pages powered by Contractor Commerce plugin (key: D32QhwUokdL5YZLParGpbxc7TuBTkYanGNQSR4zd): Free Online HVAC Quote (`/free-hvac-quote`) provides instant pricing calculator for HVAC system replacement with system selection, detailed trust signals, and comprehensive FAQ section. Free Online Water Heater Quote (`/water-heater-quote`) offers real-time quotes for tank and tankless water heaters with comparison guide, installation details, and expert consultation CTAs. Filter Shop (`/filter-shop`) enables e-commerce purchase of air filters with MERV rating education, filter type comparison, professional installation options, and benefits of regular filter changes. Plugin loaded globally in root layout via ContractorCommercePlugin component for optimal performance and site-wide availability. All pages feature mobile-optimized design, SchedulerCluster components for alternative booking paths, and conversion-focused layouts with trust indicators.
- **Promotional Offer Pages:** New Homebuyer Offer (`/new-homebuyer-offer`) features FREE 2-Year Deluxe Family Protection Plan ($1,200 value) with comprehensive benefits display, trust indicators, lead capture form with validation, and Offer JSON-LD schema. REALTORS® Offer (`/realtors-offer`) positions the same protection plan for realtors to gift clients, includes realtor-specific benefits section, client registration form, 30-day activation disclaimer, and proper SEO metadata with realtor-targeted keywords. **$28.88 Drain Clearing Special** displayed prominently on drain clearing pages (`/services/drain-clearing-tucson` and `/services/rooter-special`) with eye-catching coupon-style component (DrainClearingCoupon) featuring scissors icons, dashed borders, gradient backgrounds, prominent pricing display, service highlights, dual CTA buttons (phone + scheduler), and positioning above the fold between TrustBar and Highlights for maximum conversion impact.
...
- **Contractor Commerce:** Interactive pricing calculator and e-commerce plugin for HVAC quotes, water heater quotes, and filter sales (API key: D32QhwUokdL5YZLParGpbxc7TuBTkYanGNQSR4zd). Provides real-time pricing, product selection interfaces, and conversion-optimized checkout flows. Loaded globally in `<head>` via ContractorCommercePlugin component for site-wide availability. Navigator keys: NzdTlJWvihCCWjsf (HVAC), ugVQLX7twEC3x7nG (Water Heater), uaab4SY6TlT6rnz5 (Filter Shop).
