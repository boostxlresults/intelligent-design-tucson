...
export default function MobileFloatingActions() {
  return (
    <>
      ...
      {/* HatchChat bubble is positioned above this bar via CSS */}
      <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-background border-t border-border shadow-lg max-w-full overflow-hidden">
        <div className="flex items-center justify-center gap-2 px-4 py-3">
          ...
          <Button
            size="sm"
            className="flex-1 flex flex-col items-center gap-1 h-auto py-3 bg-yellow-400 border-2 border-yellow-500 text-gray-900 hover:bg-yellow-500 max-w-[160px]"
            asChild
          >
