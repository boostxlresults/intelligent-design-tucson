...
export default function Hero() {
  return (
    <>
      {/* ─── HERO SECTION ─────────────────────────────────────────────── */}
      <section className="relative min-h-[520px] md:min-h-[500px] flex items-start overflow-hidden">
      ...
      <div className="md:hidden bg-white px-4 py-5 flex flex-col gap-3 shadow-sm">
        ...
        <Button
          size="lg"
          variant="outline"
          className="w-full text-lg py-6 h-auto bg-green-600 border-2 border-green-700 text-white hover:bg-green-700 font-bold justify-center"
          asChild
        >
