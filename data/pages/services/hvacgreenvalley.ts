...
export const hvacgreenvalleyData: ServicePageData = {
  ...
  h2Subheading: 'Reliable, Energy-Efficient Comfort Solutions Since 1979 | 23,000+ Five-Star Reviews',
  ...
  highlights: [
  {
    "title": "46+ years Serving Green Valley Retirees",
  ...
  content: {
    ...
    sections: [
      ...
      {
            "type": "paragraph",
            "content": "Trusted by Green Valley's Retirement Community: Intelligent Design has earned the trust of over 8,500 Green Valley families with a nearly perfect 4.97-star Google rating from 23,000+ verified reviews across all our service areas. We're the #1 referred HVAC company in Green Valley, with most of our business coming from satisfied customers who recommend us to their neighbors, friends, and family. Our BBB A+ accreditation since 1979 with zero unresolved complaints demonstrates our unwavering commitment to customer satisfaction. We understand the importance of clear communication, transparent pricing, and reliable service for retirees managing fixed incomes and counting on their HVAC systems for health and comfort. When you choose Intelligent Design for your [link:/services/ac-repair-tucson|AC repair], [link:/services/ac-installation-tucson|installation], or [link:/services/ac-service-tucson|maintenance needs], you're selecting the company your Green Valley neighbors have trusted for over four decades."
      },
      {
            "type": "paragraph",
