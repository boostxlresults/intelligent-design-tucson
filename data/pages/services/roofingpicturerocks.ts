...
// Auto-generated from RoofingPictureRocks.tsx
...
export const roofingpicturerocksData: ServicePageData = {
  ...
  description: 'Professional roofing services in Picture Rocks, AZ. Expert roof repair, replacement, inspection, coating. Tile, shingle, flat roofs. 24/7 emergency service. BBB A+ rated.',
  slug: 'roofing-picture-rocks',
  
  // Hero Section
  h1: 'Professional Roofing Services in Picture Rocks, AZ',
  h2Subheading: 'Expert Roofing Picture Rocks in Tucson',
  tagline: 'Roof Repair | Replacement | Inspection | Coating | Tile & Shingle | 24/7 Emergency Service',
  heroImage: '/images/placeholder.webp',
  heroImageAlt: 'Roofing Picture Rocks in Tucson',
  
  // Service Info
  serviceName: 'Roofing Picture Rocks',
  category: 'Roofing',
  ...
  content: {
    mainHeading: 'Best Roofing Picture Rocks Company in Tucson, AZ',
    sections: [
      {
            "type": "heading",
            "heading": "Trusted Roofer Serving Picture Rocks Since 1979",
            "level": 2,
            "content": "Trusted Roofer Serving Picture Rocks Since 1979"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Complete Roofing Services for Picture Rocks",
            "level": 2,
            "content": "Complete Roofing Services for Picture Rocks"
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "paragraph",
            "content": "Local expertise since 1979. We know Picture Rocks roofing systems, climate challenges, and code requirements inside and out."
      },
      {
            "type": "paragraph",
      ...
      {
            "type": "heading",
            "heading": "Picture Rocks Roofing FAQs",
            "level": 2,
            "content": "Picture Rocks Roofing FAQs"
      },
      {
            "type": "heading",
      ...
      {
            "type": "heading",
            "heading": "Need a Roofer in Picture Rocks?",
            "level": 2,
            "content": "Need a Roofer in Picture Rocks?"
      },
      {
            "type": "paragraph",
  ...
  commonQuestions: getRefinementQuestions('Roofing', 'Picture Rocks'),
};
