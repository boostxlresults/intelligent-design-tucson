...
export const solarCategoryData: ServiceCategoryData = {
  ...
  whyChooseUs: [
    {
      title: 'Local Solar Experts',
      description: 'We understand Tucson\'s unique climate and design systems optimized for Arizona sunshine.'
    },
    {
      title: 'Complete Service',
      description: 'From consultation to installation to maintenance, we handle every aspect of going solar.'
    },
    {
      title: 'Quality Equipment',
      description: 'We install premium solar panels and inverters backed by manufacturer warranties.'
    },
    {
      title: 'Financing Available',
      description: 'Multiple financing options to fit your budget. Many customers see immediate savings.'
    },
    {
      title: 'Tax Credit Assistance',
      description: 'We help you navigate federal and state solar incentives to maximize your savings.'
    },
    {
