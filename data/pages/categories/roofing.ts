...
export const roofingCategoryData: ServiceCategoryData = {
  ...
  description: 'Expert roofing services in Tucson, AZ. Roof repair, replacement, coating & inspections. Residential & commercial. Veteran-owned, 23,000+ 5-star reviews.',
  slug: 'roofing',
  ...
  whyChooseUs: [
    {
      title: 'Monsoon Ready',
      description: 'We understand Tucson weather and prepare your roof for monsoon season.'
    },
    {
      title: 'Free Inspections',
      description: 'Complimentary roof inspections to assess your roof\'s condition and needs.'
    },
    {
      title: 'Quality Materials',
      description: 'Premium roofing materials designed to withstand Arizona\'s extreme climate.'
    },
    {
      title: 'Expert Craftsmanship',
      description: 'Experienced roofers with attention to detail and pride in their work.'
    },
    {
      title: 'Insurance Claims Help',
      description: 'We work with your insurance company to make storm damage claims easier.'
    },
    {
      title: 'Workmanship Warranty',
      description: 'All roofing work backed by our comprehensive warranty for peace of mind.'
    }
  ]
};
