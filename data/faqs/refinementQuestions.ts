...
export function getPlumbingRefinementQuestions(location: string): FAQItem[] {
  return [
    ...
    },
    {
      ...
      answer: `Yes. Intelligent Design offers professional drain cleaning in ${location} using hydro-jetting, cable machines, and video camera inspection. Our $48.88 drain clearing special covers standard drain clogs. For stubborn blockages, tree root intrusion, or recurring problems, we use sewer camera inspection to identify the exact issue and recommend the right solution.`
    },
    {
